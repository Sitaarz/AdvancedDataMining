...
from src.DataDownload.models.domain.movie_data import Movie
        ...
        if len(movie.Genre) > 0:
            for genre in movie.Genre:
                ...
                for actor in movie.Actors:
                    ...
                    self._cursor.execute(f"INSERT OR REPLACE INTO movies ({columns}, genre, actors) VALUES ({placeholders}, ?, ?)", values + (genre.strip(), actor.strip()))
        else:
